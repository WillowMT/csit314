                    ...
                    <div className=" px-4 py-8 flex flex-col min-h-[250px] w-full">
                        ...
                        <div className=" space-x-2 inline-flex place-items-center">
                            <Button size="md" isIconOnly variant="ghost">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="w-3 h-3 text-slate-500/60">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 0 0-2.25 2.25v9a2.25 2.25 0 0 0 2.25 2.25h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H15m0-3-3-3m0 0-3 3m3-3V15" />
                                </svg>
                            </Button>
                            <Button size="md" isIconOnly variant="flat" color="secondary">
                                <svg color="secondary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" className="w-3 h-3 ">
